...
const unsigned char*   dsaKeyBuffer = dsa_key_der_2048;//{ /*holds the raw data from the DSA key, maybe from a file like dsa512.der*/ };
...
wc_DsaPrivateKeyDecode(dsaKeyBuffer, &idx, &key, sizeof_dsa_key_der_2048);
